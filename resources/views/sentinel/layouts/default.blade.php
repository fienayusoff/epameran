		...
		<div class="navbar navbar-inverse navbar-fixed-top">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="{{ route('home') }}">ePameran</a>
	        </div>
	        <div class="collapse navbar-collapse">
	          ...
	          <ul class="nav navbar-nav navbar-right">
	            @if (Sentry::check())
				<li {{ (Request::is('profile') ? 'class="active"' : '') }}><a href="{{ route('sentinel.profile.show') }}">{{ Session::get('first_name') }}</a>
				</li>
				<li>
